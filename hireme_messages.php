...
<div class="container center text-center bg-gray box" style="padding:50px;margin-top:100px;">	
	<h2>Hire proposal From Clients</h2>
		...
		<?php
			...
			if($username=='ashoyon' && $password=='bs546496')
			{
				print "<tr>";
					...
					print "<th style='text-align:center;'>Website</th>";
					print "<th style='text-align:center;'>Project</th>";
					print "<th style='text-align:center;'>Project Type</th>";
					print "<th style='text-align:center;'>Budget</th>";
			...
			$filename = $DOCUMENT_ROOT.'SpiderWeb/data/'.'hireme.txt';
			...
			if(file_exists($filename))
			{
					...
					while(true)
				{
					...
					list($name, $email, $subject, $website, $project, $project_type, $budget, $contact_date, $message) = explode('|',$line);
					$display .="<tr $style>";
						$display .="<td>".$name."</td>";
						$display .="<td>".$email."</td>";
						$display .="<td>".$subject."</td>";
						$display .="<td>".$website."</td>";
						$display .="<td>".$project."</td>";
						$display .="<td>".$project_type."</td>";
