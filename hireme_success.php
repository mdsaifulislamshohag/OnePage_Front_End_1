...
<div class="container center text-center bg-gray box" style="padding:50px;margin-top:100px;">
	...
	//gather data from the form
		...
		$message = $_POST['message'];
			...
			$output_line = $name. '|'.$email.'|'.$subject.'|'.$website.'|'.$project.'|'.$project_type.'|'.$budget.'|'.$contact_date.'|'.$message."\n";
			...
			print "<p>your email is <b><u>$email</u></b> </p>";
			print "<p>subject : $subject </p>";
			print "<p>your website is : $website </p>";
			print "<p>you are hiring me for $project ($project_type)</p>";
			print "<p>your budjet is $budget ($project_type) </p>";
